...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("format-all-" "terraform-fmt" "shfmt" "sqlformat" "swiftformat" "rufo" "rustfmt" "perltidy" "prettier" "ocp-indent" "mix-format" "ledger-mode" "lua-fmt" "ktlint" "html-tidy" "gofmt" "elm-format" "emacs-lisp" "define-format-all-formatter" "dartfmt" "dfmt" "dhall" "crystal" "black" "brittany" "asmfmt")))
